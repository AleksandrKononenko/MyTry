...
- кількість енергії впливає на швидкість пересування та продовження роду.
- їжа, яка повинна давати енергію для життя, а також для продовження роду.
- популяція.
...
### 2. Вплив максималької кількості галочок на середню популяцію.
